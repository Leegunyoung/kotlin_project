...
import com.example.mini_game_project.MainActivity
import com.example.mini_game_project.R
import com.example.mini_game_project.databinding.FragmentNumberGameBinding
import java.text.DecimalFormat
import kotlin.concurrent.thread

class NumberGame : Fragment() {

    var binding: FragmentNumberGameBinding?= null
    ...
    override fun onCreateView(
        ...
        binding = FragmentNumberGameBinding.inflate(inflater)
        return binding?.root
    ...
    private fun check_answer(currentAns: String){
        ...
        if (currentAns.toInt() == currentGoal.toInt()) {
            ...
            if (currentGoal.toInt() == 10) {
                ...
                findNavController().navigate(R.id.action_numberGame_to_numberRank,bundle)
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.btnEntry?.setOnClickListener {
            findNavController().navigate(R.id.action_numberGame_to_play)
        }
        ...
        thread(start = true) {
            ...
            while (true) {
                ...
                mainActivity.runOnUiThread {
                    binding?.fTouchGameTvTime?.text =
                        "Time : " + df2.format(second).toString() + " sec"
                }
            }
        }
    }
